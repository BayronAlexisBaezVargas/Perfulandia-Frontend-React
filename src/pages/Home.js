            ...
            <div className="row d-flex mt-2 ">
                ...
                <div className="col-md-4 mt-1 ">
                    <div className="card mb-4 h-100">
                        <img height="250" className="card-img-top" src={prducto1} alt=""/>
                        <div className="card-body d-flex flex-column">
                            ...
                            <button className="text-dark mt-auto" onClick="window.location.href='Productos.html'">Ver
                                mas
                            </button>
                        </div>
                    </div>
                ...
                <div className="col-md-4 mt-1">
                    <div className="card mb-4 h-100">
                        <img height="250" className="card-img-top" src={prducto2} alt=""/>
                        <div className="card-body d-flex flex-column ">
                ...
                <div className="col-md-4 mt-1">
                    <div className="card mb-4 h-100">
                        <img height="250" className="card-img-top" src={prducto3} alt=""/>
                        <div className="card-body d-flex flex-column">
